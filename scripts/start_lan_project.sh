...
echo "🚀 WYL检测法完整项目启动脚本（支持局域网访问）"
echo "=================================================="
echo "此脚本将启动Django后端和React前端，支持局域网内其他设备访问"
echo ""
...
# 启动前端（绑定到所有网络接口）
echo "启动前端服务（支持局域网访问）..."
npm run dev:client -- --host 0.0.0.0 --port 3002 &
FRONTEND_PID=$!
...
echo ""
echo "💡 提示："
echo "   - 局域网内其他设备可以通过 $LAN_IP:3002 访问前端"
echo "   - 确保防火墙允许端口 3002 和 8000 的访问"
