...
const ResultsDebugScreen: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold">结果调试页面</h1>
          <p className="text-sm text-slate-400 mt-1">调试所有检测结果，支持分类筛选</p>
        </div>
...
export default ResultsDebugScreen;
