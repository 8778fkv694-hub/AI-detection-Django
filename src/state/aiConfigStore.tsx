    ...
    export const useAIConfigStore = create<AIConfigState>()(persist((set) => ({ config: { apiKey: '', baseUrl: '', modelName: '', systemPrompt: defaultSystemPrompt }, setConfig: (newConfig) => set({ config: newConfig }), }), { name: 'ai-config-storage', storage: createJSONStorage(() => localStorage) }));
